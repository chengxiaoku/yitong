            ...
            <div class="col-md-12">
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <!--基本信息-->
                        <!-- form start -->
                        <form role="form" id="loginForm" action="<?php echo U('member/add');?>" method="post">
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    ...
                                    <div class="form-group" style="height: 34px">
                                            ...
                                            <div class="input-group" style="position: relative; left: 124px; top: -25px;">
                                                <input type="text" disabled="disabled" placeholder="上传头像 ..."  style="width: 150px;"  class="form-control" id="uiFileUploadInput1" data-thumb="">
                                                <input type="hidden" id="jb_image" name="headimg" >
                                    ...
                                    <div class="form-group" style="height: 34px">
                                            ...
                                            <div class="input-group" style="position: relative; left: 124px; top: -25px;">
                                                <input type="text" disabled="disabled" placeholder="上传身份证照片 ..." style="width: 150px;"  class="form-control" id="uiFileUploadInput" data-thumb="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w200 inline-block province" name="level" id="level">
                                            <?php if(is_array($grad)): $i = 0; $__LIST__ = $grad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i; if($lists['level'] == $i-1): ?><option selected="selected" value="<?php echo ($i-1); ?>"><?php echo ($row); ?></option>
                                                    <?php else: ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio inline-block margin0">
                                            <label>
                                                <input checked="checked" value="male"  name="sex" type="radio">男
                                            </label>
                                        </div>
                                        <div class="radio inline-block margin0">
                                            <label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w200 inline-block province" name="educational" id="educational">
                                            <?php if(is_array($_data)): $i = 0; $__LIST__ = $_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i; if($lists['educational'] == $i-1): ?><option selected="selected" value="<?php echo ($i-1); ?>"><?php echo ($row); ?></option><?php endif; ?>
                                        ...
                                        <div style="margin-left: 45px;">
                                            ...
                                            <div class="inline-block">
                                                <div class="input-group">
                                                    <input type="text" style="left: 5px;" name="graduation_date" placeholder="输入毕业时间 ..." id="begin-time" class="form-control" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control w200 inline-block province" name="duty_level" id="duty_level">
                                            <?php if(is_array($duty_level)): $i = 0; $__LIST__ = $duty_level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row2): $mod = ($i % 2 );++$i; if($i-1 == $lists['duty_level']): ?><option selected="selected" value="<?php echo ($i-1); ?>"><?php echo ($row2); ?></option>
                                                    <?php else: ?>
                                    ...
                                    <div class="form-group">
                                       <div style="margin-left: 45px;">
                                            ...
                                            <div class="inline-block">
                                                <div class="input-group">
                                                    <input type="text" style="left: 5px;" name="training_time" placeholder="输入培训时间 ..." id="bg-time" class="form-control">
                                                    <div class="input-group-btn">
