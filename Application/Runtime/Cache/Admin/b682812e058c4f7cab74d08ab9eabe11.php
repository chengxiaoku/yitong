                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <th width="10%"><?php echo ($row['username']); ?></th>
                                    <th width="10%"><?php echo ($arr[$i-1]); ?></th>
                                    <th width="10%"><?php echo ($row['lastip']); ?></th>
                                    <th width="10%"><?php echo ($row['addtime']); ?></th>
                                    <th width="10%"><?php echo ($row['realname']); ?></th>
                                    <th width="10%">
