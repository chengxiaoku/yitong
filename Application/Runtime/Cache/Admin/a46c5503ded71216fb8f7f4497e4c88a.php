        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" id="loginForm" action="<?php echo U('admin/video/edit');?>" method="post">
                        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                        <div class="box-body padding20">
                            <div class="form-group">
                                <label for="">视频名称<span class="required">*</span></label>
                                <input type="text" placeholder="输入视频名称" value="<?php echo ($data["title"]); ?>" name="title" required class="form-control wp50" >
                            </div>
                            <div class="form-group">
                            ...
                            <div id="specialty_grade_name">
                                <div class="form-group">
                                    ...
                                    <select name="specialty_id" class="form-control w200">
                                        <?php if(is_array($video_specialty)): foreach($video_specialty as $key=>$video_specialty): ?><option value="<?php echo ($video_specialty["id"]); ?>"
                                            <?php if(($data['specialty'] == $video_specialty['id'])): ?>selected<?php endif; ?>
                                            ><?php echo ($video_specialty["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="输入时长" value="<?php echo ($data["duration"]); ?>" name="duration" required class="form-control wp50" >
                            </div>

                            <div class="form-group">
                                <label for="">视频学时（数字）<span class="required">*</span></label>
                                <input type="text" placeholder="输入学时" value="<?php echo ($data["period"]); ?>" name="period" required class="form-control wp50" >
                            </div>

                            <div class="form-group">
                                <label for="">视频状态<span class="required">*</span></label>
                                <div>
                                    <?php if($data["status"] == 1): ?><div class="radio inline-block margin0">
                                            <label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Enter ..." rows="3" class="form-control" name="description" required><?php echo ($data["description"]); ?></textarea>
                            </div>
                            ...
                            <div class="form-group input-group wp50">
                                ...
                                <div>
                                    <div class="input-group">
                                        <input type="text" name="video_url" readonly="readonly" value="<?php echo ($data["video_url"]); ?>" id="upload_thumb" class="form-control" placeholder="上传视频 ...">
