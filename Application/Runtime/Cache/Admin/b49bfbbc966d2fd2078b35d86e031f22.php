        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <!-- form start -->
                    <form role="form" action="<?php echo U('admin/update');?>" method="post" id="Myform">
                        ...
                        <div class="box-body padding20">
                            <div class="form-group ">
                                ...
                                <div>
                                    <input type="text" name="user" value="<?php echo ($user_data['username']); ?>" placeholder="输入用户名称" id="" class="form-control wp50 inline-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="输入姓名" value="<?php echo ($user_data['realname']); ?>" name="name" class="form-control wp50" >
                            </div>
                            <div class="form-group">
                                <label class="">上传头像：</label>
                                <div class="input-group" style="">
                                    <input type="text" disabled="disabled" value="<?php echo ($user_data['headimg']); ?>" placeholder="上传头像 ..." style="width: 320px;"  class="form-control wp50" id="uiFileUploadInput3_3" data-thumb="">
                                    <input type="hidden" name="img" value="<?php echo ($user_data['headimg']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo ($user_data['roleid']); ?>
                                <select class="form-control wp50" name="role"  title="Please select something!" required>
                                    <?php foreach($data as $val) :?>
                                    <?php if($user_data['roleid'] == $val['id']): ?><option selected="selected" value="<?php echo $val['id']?>"><?php echo $val['name']?></option>
                                        <?php else: ?>
                                        <option  value="<?php echo $val['id']?>"><?php echo $val['name']?></option><?php endif; ?>
