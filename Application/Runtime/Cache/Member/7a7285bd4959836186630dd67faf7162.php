...
<head>
    ...
    <style type="text/css">
        ...
        #header {
            ...
            background: #0BB20C none repeat scroll 0 0;
            margin: 0 auto !important;
            text-align: center;
            line-height: 60px;
            color: #fff;
        ...
        .login-page {
            background: #ededed url("<?php echo ASSETS;?>/img/login-bg.png") no-repeat scroll center top;
        }
...
<div class="login-box" style="">
    ...
    <div class="login-box-body">
        ...
        <div class="login-logo"><i class="fa fa-street-view"></i>&nbsp;&nbsp;个人用户登录</div>
        ...
        <form action="<?php echo U('auth/login');?>" method="post" name="loginform" id="myform">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="username" class="form-control" placeholder="身份证号" tabindex="1"/>
            ...
            <br>
            <a href="./zhuce.php?m=zhuce&c=referee&a=index">我要注册</a>

            <div class="row">
                <div class="col-xs-12">
                    <hr>
                    <p style="padding:20px 0 10px;">
                        Copyright &copy; 2016 <a href="#">易通建筑</a></strong> 版权所有.
                    </p>
                </div>
            </div>
