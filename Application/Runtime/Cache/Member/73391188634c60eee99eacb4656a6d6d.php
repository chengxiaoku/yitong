                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="#"><i class="fa fa-inbox"></i> 低 </a></li>
                        </ul>
                    </div><!-- /.box-body -->
                </div><!-- /. box -->
            </div><!-- /.col -->
                    ...
                    <div class="box-body no-padding">
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                <?php if(is_array($course_message)): $i = 0; $__LIST__ = $course_message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course_message): $mod = ($i % 2 );++$i;?><tr>
                                        <td><?php echo ($course_message["title"]); ?></td>
                                        <td class="text-center"><?php echo ($course_message["period"]); ?></td>
                                        ...
                                        <td class="text-center">
                                            <a class="label bg-green" href="<?php echo U('publictrain/video');?>&id=<?php echo ($course_message["id"]); ?>">播放</a>
                                        </td>
